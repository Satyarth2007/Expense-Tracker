-- ============================================================
-- Ledger — schema.sql
-- Target: Neon PostgreSQL (Postgres 15+)
...
-- ============================================================
-- ENUM types
-- Native enums instead of VARCHAR + CHECK: smaller on-disk footprint,
-- faster comparisons/indexing, self-documenting. Trade-off: adding a
-- new value later needs ALTER TYPE ... ADD VALUE (cheap, non-blocking
-- in PG 12+, but can't run in the same transaction as other DDL that
...
-- ============================================================
-- Table: categories (self-referencing via parent_id)
-- ============================================================
...
-- ============================================================
-- Table: fx_rates (standalone lookup table, no FKs)
-- ============================================================
...
-- ============================================================
-- Table: audit_logs (append-only — no updated_at / update trigger)
-- ============================================================
